...
test.describe("Adhesion", () => {
  ...
  test("Adhesion, paiement cb, email non lié", async () => {
    ...
    await expect(page.locator('#popup-cashless bouton-basique[class="test-ref-cashless"]', { hasText: `${totalTrans} 40 ${currencySymbolTrans}` })).toBeVisible()
  ...
  //TODO: achat en espèce 500 ; faire le retour pour le reste à rendre
